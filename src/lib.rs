...
pub const CURRENT_BLOCK_HEIGHT: u64 = 790_000;
...
pub fn validate_block_height(height: i64) -> (bool, String) {
    ...
    if height < 0 {
        ...
        (false, "Unrealistic block height".into())
    } else {
...
pub fn extract_tx_version(raw_tx_hex: &str) -> Result<u32, String> {
    // TODO: Parse the raw transaction hex and extract the version field
    // The version is typically the first 4 bytes (8 hex characters) of the transaction
    if raw_tx_hex.len() < 8 {
